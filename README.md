...
YaMDB высылает письмо с кодом подтверждения (confirmation_code) на адрес email (функция в разработке).
...
# Проект в разработке
Необходимо доработать отправку кода при регистрации на e-amil и подключить проект к Postgres.
